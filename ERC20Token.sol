...
contract ERC20Token {               // Public variables of the token
    string public name;
    string public symbol;
    uint8 public decimals = 18;     // 18 decimals (default!)
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        assert(balanceOf[_from] + balanceOf[_to] == previousBalances);  // Static analysis, should be true!
    }
